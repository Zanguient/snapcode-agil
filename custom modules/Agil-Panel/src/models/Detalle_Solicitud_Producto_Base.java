 ...
 * @author AGIL
 */
public class Detalle_Solicitud_Producto_Base {
    ...
    public Detalle_Solicitud_Producto_Base(int detalle_solicitud_producto, int producto_base, double cantidad_ideal, double cantidad_real, Date createdat, Date updatedat, double total) {
