 ...
 * @author AGIL
 */
public class EditarConfFactura extends java.awt.Dialog {
     ...
     */
    public EditarConfFactura(java.awt.Frame parent, boolean modal,int id_factura) {
        super(parent, modal);
        initComponents();
        setLocationRelativeTo(this);
        setTitle("Configuracion de Factura");   
    ...
    public void mostrarDatosFacturacion(){
        ResultSet rs = null;
        int num = 1;
        String consulta = "SELECT IMP.NOMBRE,TIP.NOMBRE,TAM.NOMBRE,TIT.NOMBRE,SUBTIT.NOMBRE,CF.USAR_PF,CF.IMPRIMIR_AL_GUARDAR,\n" +
            "NOVENTA.NOMBRE,NOTRAS.NOMBRE,NOBAJA.NOMBRE,NOPEDIDO.NOMBRE,CIEBAJO.NOMBRE,COTIZA.NOMBRE\n" +
            "FROM SUCURSAL AS S\n" +
            ...
            "LEFT JOIN CLASE AS NOVENTA ON NOVENTA.ID = CF.TAMANO_PAPEL_NOTA_VENTA\n" +
            "LEFT JOIN CLASE AS NOTRAS ON NOTRAS.ID = CF.TAMANO_PAPEL_NOTA_TRASPASO\n" +
            "LEFT JOIN CLASE AS NOBAJA ON NOBAJA.ID = CF.TAMANO_PAPEL_NOTA_BAJA\n" +
            "LEFT JOIN CLASE AS NOPEDIDO ON NOPEDIDO.ID = CF.TAMANO_PAPEL_NOTA_PEDIDO\n" +
            "LEFT JOIN CLASE AS CIEBAJO ON CIEBAJO.ID = CF.TAMANO_PAPEL_CIERRE_CAJA\n" +
            "LEFT JOIN CLASE AS COTIZA ON COTIZA.ID = CF.TAMANO_PAPEL_COTIZACION\n" +
            "WHERE CF.ID = "+this.id_factura+" AND S.ELIMINADO = "+false;
        try {
            rs = db.seleccionar(consulta);
            while (rs.next()) {   
                
                comboImpresion.setSelectedItem(rs.getString(1));
                comboTipFactu.setSelectedItem(rs.getString(2));
                comboTamPapel.setSelectedItem(rs.getString(3));
                comboTitulo.setSelectedItem(rs.getString(4));
                comboSubtitulo.setSelectedItem(rs.getString(5));
                radioUsarPF.setSelected(rs.getBoolean(6));
                radioImprimirGuardar.setSelected(rs.getBoolean(7));
                comboPapelNotaVenta.setSelectedItem(rs.getString(8));
                comboPapelNotaTraspaso.setSelectedItem(rs.getString(9));
                comboPapelNotaPedido.setSelectedItem(rs.getString(10));
                comboPapelCierreCaja.setSelectedItem(rs.getString(11));
                comboPapelCotizacion.setSelectedItem(rs.getString(12));
    ...
    public void actualizarConfFactura(){
       ...
       // boolean usar = radioUsar.isSelected();
        ...
        db.actualizarConfigFactura(this.id_factura, idImpresion, idTipoFactura, idTamañoPapel, idTitulo, idSubTitulo, usarPF, imprimirGuardar, updatedat,idPapelNotaVenta, idPapelNotaTraspaso, idPapelNotaBaja, idPapelNotaPedido, idPapelCierreCaja, idPapelCotizacion);
    ...
    private void initComponents() {
        ...
        comboImpresion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel3.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(70, 143, 204));
        jLabel3.setText("Tipo Facturación");

        comboTipFactu.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel4.setForeground(new java.awt.Color(70, 143, 204));
        jLabel4.setText("Tamaño Papel");

        comboTamPapel.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        ...
        comboTitulo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel6.setForeground(new java.awt.Color(70, 143, 204));
        jLabel6.setText("Subtítulo");

        comboSubtitulo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
        ...
        comboPapelNotaVenta.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel8.setForeground(new java.awt.Color(70, 143, 204));
        jLabel8.setText("Tamaño Papel Nota Traspaso");

        comboPapelNotaTraspaso.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel9.setForeground(new java.awt.Color(70, 143, 204));
        jLabel9.setText("Tamaño Papel Nota Baja");

        comboPapelNotaBaja.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel10.setForeground(new java.awt.Color(70, 143, 204));
        jLabel10.setText("Tamaño Papel Nota Pedido");

        comboPapelNotaPedido.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel11.setForeground(new java.awt.Color(70, 143, 204));
        jLabel11.setText("Tamaño Papel Cierre Caja");

        comboPapelCierreCaja.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));

        jLabel12.setForeground(new java.awt.Color(70, 143, 204));
        jLabel12.setText("Tamaño Papel Cotización");

        comboPapelCotizacion.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { " " }));
