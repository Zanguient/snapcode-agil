...
START TRANSACTION;
update agil_gtm_despacho_detalle despacho INNER JOIN agil_producto as producto ON despacho.producto = producto.id
set despacho.saldo_pago_ac =(despacho.cantidad_despacho*producto.precio_unitario+despacho.servicio_transporte),
despacho.total =(despacho.cantidad_despacho*producto.precio_unitario+despacho.servicio_transporte),
despacho.pago_ac =0
