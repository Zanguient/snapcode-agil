angular.module('agil.controladores')
    ...
    .controller('ControladoresFarmacia', ['$scope', '$localStorage', '$location', '$templateCache',' $route', '$filter', '$window', '$timeout', 'blockUI', 'ClasesTipo', 'ConfiguracionVentaVistaDatos',
        'ProductosPanel', 'InventarioPaginador', 'ListaInventariosProducto', 'ListaProductosEmpresa', 'Venta', 'PacientesNit', 'ImprimirSalidaFarmacia', 'Ventas', 'VentasFarmacia', 'DatosVentaFarmacia',
        'VentaEmpresaDatos', 'VentaFarmacia', function ($scope, $localStorage, $location, $templateCache, $route, $filter, $window, $timeout, blockUI, ClasesTipo, ConfiguracionVentaVistaDatos,
        ProductosPanel, InventarioPaginador, ListaInventariosProducto, ListaProductosEmpresa, Venta, PacientesNit, ImprimirSalidaFarmacia, Ventas, VentasFarmacia, DatosVentaFarmacia,
        VentaEmpresaDatos, VentaFarmacia) {
